    ...
    <>
      ...
      <section>
        <div className="flex flex-col-reverse md:flex-row md:h-[485px]">
          <div className="relative bg-darkRed text-white place-content-center md:w-[50%] p-20 md:mr-4 md:before:content-[''] md:before:absolute md:before:top-0  md:before:w-full md:before:h-full md:before:bg-darkRed md:before:transform md:before:-skew-x-[9deg] md:before:origin-top-left md:before:z-[-1]">
          ...
          <div className="bg-casa-pattern bg-cover bg-center lg:bg-medium-half-width md:bg-half-width md:bg-right-half bg-no-repeat w-full h-[500px] md:absolute md:-z-10"></div>
        </div>
      </section>
